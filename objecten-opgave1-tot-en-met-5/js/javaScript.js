...
//Opgave V
function OBJLessen (studentnummer,klasnaam,opleiding,lessen){
  let OBJLessen = this;
  OBJLessen.Studentnummer = studentnummer;
  OBJLessen.Klasnaam = klasnaam;
  OBJLessen.Opleiding = opleiding;
  OBJLessen.Lessen = lessen;
}

let studentO5 = new OBJLessen (30168,'MD1B','Mediadevelopment','FRO');

//typeof(student.Studentnummer);

let forIn05="";
for (const property in studentO5) {
forIn05+=(`${property}: ${studentO5[property]}`+'<br/>');
}document.write('<br/>'+'<br/>'+"Opgave 5 OOP" +'<br/>'+ forIn05);

//Opgave V.I
let OBJLessen2 = new Object();

OBJLessen2.Studentnummer = student2.Studentnummer;//
OBJLessen2.Klasnaam = student2.Klasnaam;
OBJLessen2.Opleiding = student2.Opleiding;
OBJLessen2.Lessen = 'FRO';

document.write('<br/>'+"Opgave 5 constructor"+'<br/>'+OBJLessen2.Studentnummer
+'<br/>'+OBJLessen2.Klasnaam
+'<br/>'+OBJLessen2.Opleiding
+'<br/>'+OBJLessen2.Lessen
);
